...
import { BRAND_QUOTE, DEFAULT_WHATSAPP_NUMBER, DEFAULT_WHATSAPP_TEXT, INSTAGRAM_URL, readLogoUrl, readVideoUrl } from "@/data/brand";
...
export default function Home() {
  ...
  return <div className="site-shell">
    <header className={`site-nav ${scrolled ? "is-scrolled" : ""}`}>
      ...
      <nav className="desktop-nav" aria-label="Main navigation"><a href="#collection">Collection</a><a href="#about">The house</a><a href="#contact">Queries</a></nav>
    ...
    <div className={`mobile-drawer ${menuOpen ? "is-open" : ""}`}><nav><a href="#collection" onClick={() => setMenuOpen(false)}>Collection</a><a href="#about" onClick={() => setMenuOpen(false)}>The house</a><a href="#contact" onClick={() => setMenuOpen(false)}>Queries</a></nav><span>isth / 2026</span></div>
    ...
    <main>
      <section className="home-hero">
        ...
        <div className="home-hero-content"><p className="eyebrow light">Fine fragrance house</p><h1>A scent can<br /><em>change the air.</em></h1><p className="hero-description">isth composes modern signatures from notes that stay close, then open slowly.</p><div className="hero-cta-row"><a className="cherry-button hero-whatsapp" href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(whatsappText)}`} target="_blank" rel="noreferrer"><MessageCircle size={17} /> WhatsApp the house</a><a className="outline-button" href="#collection">Explore the Collection <ArrowDown size={14} /></a></div></div>
      ...
      <div className="ingredient-marquee" aria-label="Fragrance notes"><div>OUD&nbsp;&nbsp;·&nbsp;&nbsp; DARK CHERRY&nbsp;&nbsp;·&nbsp;&nbsp; AMBER&nbsp;&nbsp;·&nbsp;&nbsp; MUSK&nbsp;&nbsp;·&nbsp;&nbsp; LOTUS&nbsp;&nbsp;·&nbsp;&nbsp; ROSE&nbsp;&nbsp;·&nbsp;&nbsp; OUD&nbsp;&nbsp;·&nbsp;&nbsp; DARK CHERRY&nbsp;&nbsp;·&nbsp;&nbsp; AMBER&nbsp;&nbsp;·&nbsp;&nbsp; MUSK&nbsp;&nbsp;·&nbsp;&nbsp; LOTUS&nbsp;&nbsp;·&nbsp;&nbsp; ROSE&nbsp;&nbsp;·&nbsp;&nbsp;</div></div>
      ...
      <section className="quote-video-section"><div className="quote-video-backdrop" aria-hidden="true">{videoUrl ? <video src={videoUrl} autoPlay muted loop playsInline /> : null}</div><div className="quote-video-copy"><p className="eyebrow light">The isth point of view</p><h2>{BRAND_QUOTE}</h2><a className="cherry-button" href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(whatsappText)}`} target="_blank" rel="noreferrer"><MessageCircle size={17} /> Ask for your scent</a></div></section>

      <section className="nakshatra-section"><div className="nakshatra-texture" aria-hidden="true" /><div className="nakshatra-inner"><span className="eyebrow light">The next constellation</span><h2>NAKSHATRA<br /><em>collection.</em></h2><p>A new premium segment is taking shape. Ten new compositions, arriving when the night is right.</p><span className="coming-soon">Coming soon <span>—</span> isth</span></div><div className="nakshatra-visuals" aria-label="Nakshatra image placeholders"><div className="nakshatra-image-card"><img src="/manus-storage/isth-bottle-10ml_630d74f3.png" alt="10ml tower bottle placeholder" /><span>10ml tower / image placeholder</span></div><div className="nakshatra-image-card"><img src="/manus-storage/isth-bottle-30ml_79079c93.png" alt="30ml cosmos bottle placeholder" /><span>30ml cosmos / image placeholder</span></div></div></section>

      <section id="about" className="story-section"><div className="story-image" aria-hidden="true"><div className="story-image-placeholder"><span>Editorial image placeholder</span><small>Flowers / notes / bottle</small></div></div><div className="story-flower" aria-hidden="true" /><Reveal className="story-copy"><p className="eyebrow">About isth</p><h2>Between the<br /><em>familiar &amp; unknown.</em></h2><p>isth is a lifestyle fragrance house built around the tension between what you recognise and what you cannot quite name. Familiar ingredients, given room to become something else.</p><div className="story-note-grid" aria-label="Perfume note imagery"><div className="story-note-photo note-rose"><span>Rose</span></div><div className="story-note-photo note-amber"><span>Amber</span></div><div className="story-note-photo note-musk"><span>White musk</span></div></div><div className="story-notes" aria-label="Perfume notes"><span>Rose</span><span>Amber</span><span>White musk</span><span>Lotus</span></div><a className="text-link" href="mailto:isth.support@gmail.com">Write to the house <ArrowRight size={14} /></a></Reveal></section>

...
import { BRAND_QUOTE, DEFAULT_WHATSAPP_NUMBER, DEFAULT_WHATSAPP_TEXT, readLogoUrl, readVideoUrl } from "@/data/brand";
...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <div className={`mobile-drawer ${menuOpen ? "is-open" : ""}`}><nav><a href="#collection" onClick={() => setMenuOpen(false)}>Collection</a><a href="#story" onClick={() => setMenuOpen(false)}>The house</a><a href="#contact" onClick={() => setMenuOpen(false)}>Contact</a></nav><span>isth / 2026</span></div>
    ...
    <footer className="site-footer"><div className="footer-top"><div><a href="/home" className="footer-brand"><img className="brand-logo brand-logo-dark" src={readLogoUrl()} alt="isth" /></a><p>Fine fragrance, composed quietly.</p></div><div className="footer-links"><div><span>Explore</span><a href="#collection">Collection</a><a href="#story">The house</a><a href="#contact">Contact</a></div><div><span>Direct</span><a href="mailto:isth.support@gmail.com">Email</a><a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noreferrer">WhatsApp</a></div></div></div><div className="footer-bottom"><span>© 2026 isth Fragrance House</span><span>Gujarat, India / Mon–Sat, 10am–7pm IST</span><span>Privacy · Terms</span></div></footer>
  </div>;
}

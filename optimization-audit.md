...
The catalog card alignment correction was verified at 1280px desktop, 768px tablet, and 375px smartphone widths. The prior vertical offset on alternating catalog cards is removed; bottle media, card names, notes, and buy controls now begin on consistent row baselines while the mobile single-column stack remains intact. Automated tests, TypeScript, and the production build also pass.
